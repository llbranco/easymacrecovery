...
:: Function to run the related command
:run_command
set "id=%1"
set "m_value=%2"
echo Executing command for ID: %id% with -m: %m_value%
...
echo 14. Sequoia (15)
echo.
echo 0. Exit                                           https://github.com/llbranco
echo ================================================
...
:: Submenus for each version
:lion
cls
echo 1. Mac-2E6FAB96566FE58C
echo 2. Mac-C3EC7CD22292981F
set /p id_option="Choose an option: "
